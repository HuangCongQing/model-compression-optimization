'''
Description:  (非对称量化)正常模型量化的流程是计算Scale&Zero_point=>量化=>截断=>反量化 https://blog.csdn.net/qq_40672115/article/details/129812691
Author: HCQ
Company(School): UCAS
Email: 1756260160@qq.com
Date: 2024-09-09 18:09:12
LastEditTime: 2024-09-09 18:23:24
FilePath: /model-compression-optimization/2quantization/入门必看/01浮点数值量化举例.py
'''
import numpy as np
